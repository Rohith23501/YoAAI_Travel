      ...
      <div className="footer-content-wrapper">
        ...
        <div className="footer-section footer-contact-social">
          ...
          <div className="social-icons">
            ...
            <a href="https://example.com/images/banff.jpg" aria-label="Facebook" className="social-icon">
            ...
            <a href="https://example.com/images/banff.jpg" aria-label="Twitter" className="social-icon">
            ...
            <a href="https://example.com/images/banff.jpg" aria-label="Instagram" className="social-icon">
